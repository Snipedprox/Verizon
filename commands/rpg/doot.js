...
$deletecommand
$deleteIn[25s]
$descrition[1; **$username claimed the coins before anyone else could, well done dude you earned **\`$numberSeparator[$random[1;2000];,]\`$getVar[symbol]]
