...
$onlyif[$interactionData[values[0]]==utility;]`
  ...
  type: "interaction",
  prototype: "selectMenu", 
  code: `$interactionReply[;{newEmbed:{title:Commands}{thumbnail:$userAvatar[$clientID]}{description:\`job\` **,** \`work\` **,** \`beg\` **,** \`deposit\` **,** \`withdraw\` **,** \`stream\` **,** \`shop\` **,** \`mine\` **,** \`inventory\` **,** \`buy\` **,** \`balance\` **,** \`sell\` **,** \`fish\` **,** \`hunt\` **,** \`daily\` **,** \`weekly\` **,** \`collect\` **,** \`profile\` **,** \`xp\` **,** \`box\` **,** \`boxes\` **,** \`gift\`}{footer:My server prefix is $getServerVar[prefix]}{color:$getvar[color]}};;;yes]
